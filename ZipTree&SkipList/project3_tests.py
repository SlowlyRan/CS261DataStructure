...
def zip_tree_tests():
	...
	for _ in range(num_ranks):
		try:
			a = requirements.ZipTree.get_random_rank()
...
def skip_list_tests():
	...
	print(f'find(2.5): {skip_list.find(2.5)}, Expected: b')
	print(f'find(2.2): {skip_list.find(2.2)}, Expected: c')
	print(f'find(2.1): {skip_list.find(2.1)}, Expected: d')
	print(f'find(2.6): {skip_list.find(2.6)}, Expected: e')
	...
	data = [InsertType(4, 'a', 0), InsertType(5, 'b', 0), InsertType(2, 'c', 2), InsertType(1, 'd', 1)]
	data2 = [InsertType(6, 'a', 0), InsertType(7, 'b', 0), InsertType(8, 'c', 2), InsertType(9, 'd', 1)]
	tree = create_tree_with_data(data+data2)
	...
	print(f'find(5): {skip_list.find(5)}, Expected: b')
	print(f'find(1): {skip_list.find(1)}, Expected: d')
	print(f'find(7): {skip_list.find(7)}, Expected: b')
